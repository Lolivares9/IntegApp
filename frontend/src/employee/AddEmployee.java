...
public class AddEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtDathired = new javax.swing.JTextField();
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                            ...
                                            .addGap(6, 6, 6)
                                            .addComponent(txtDepartment, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                            .addComponent(jLabel13, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                            .addGap(6, 6, 6)
                                            .addComponent(txtdesignation, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                            .addComponent(jLabel14, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                            .addGap(6, 6, 6)
                                            .addComponent(txtDathired, javax.swing.GroupLayout.PREFERRED_SIZE, 196, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(txtDathired, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (x == JOptionPane.YES_OPTION) {
            try {
                String sql = " insert into staff_info(Fname,Sname,DoB,Email,Contact,Adress1,Adress2,Apt,Pcode,department,Image,Gender,Designation,DateH,BasicS,JobT,Status) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        try {
          ...
          if(rs.next()){
           ...
           String sq="insert into Userlog(id, Username,Password) Values(?,?,?)";
    ...
    private void txtsearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtsearchKeyReleased
        ...
        try {
            ...
            if (rs.next()) {
                ...
                txtAdress1.setText(rs.getString("Adress1"));
                txtAdress2.setText(rs.getString("Adress2"));
...
//            JOptionPane.showMessageDialog(null, "No records found for ID "+txtsearch.getText());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (x == JOptionPane.YES_OPTION) {
            try {
                String sql = "delete from staff_info where id='" + txtId.getText() + "'";
                pst = conn.prepareStatement(sql);
                pst.execute();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (x == JOptionPane.YES_OPTION) {
            ...
            try {
                String sql = "update staff_info set  Fname='" + txtFname.getText() + "',Sname='" + txtSurname.getText() + "',DoB='" + txtDateOfBirth.getText() + "',Email='" + txtEmail.getText() + "',Contact='" + txtContact.getText() + "',Adress1='" + txtAdress1.getText() + "',Adress2='" + txtAdress2.getText() + "',Apt='" + txtHouseno.getText() + "',Pcode='" + txtPostalcode.getText() + "',department='" + txtDepartment.getText() + "',Image=?,Gender=?,Designation='" + txtdesignation.getText() + "',DateH='" + txtDathired.getText() + "',BasicS='" + txtbasicsalary.getText() + "',JobT='" + txtJobTittle.getText() + "',Status='" + txtJobTittle.getText() + "' where id='"+txtId.getText()+"'";
                pst = conn.prepareStatement(sql);
 ...
 try {
    ...
    private javax.swing.JTextField txtDathired;
